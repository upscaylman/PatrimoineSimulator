  ...
  return (
    <div className="relative w-full">
      <input
        type="range"
        {...props}
        className="w-full h-4 bg-gray-200 dark:bg-gray-600 rounded-lg appearance-none cursor-pointer 
                   [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:h-6 
                   [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-primary 
                   [&::-webkit-slider-thumb]:cursor-grab [&::-webkit-slider-thumb]:shadow-lg 
                   [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white 
                   [&::-webkit-slider-thumb]:dark:border-gray-700 [&::-webkit-slider-thumb]:transition-all 
                   ...
                   [&::-moz-range-thumb]:dark:border-gray-700 [&::-moz-range-thumb]:shadow-lg
                   [&::-moz-range-thumb]:active:cursor-grabbing
                   focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 
                   focus:ring-offset-white dark:focus:ring-offset-gray-800"
        style={{
          background: `linear-gradient(to right, #2563eb 0%, #2563eb ${percentage}%, rgb(229, 231, 235) ${percentage}%, rgb(229, 231, 235) 100%)`,
        }}
      />
    </div>
  );
